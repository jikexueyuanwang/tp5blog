<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"/usr/local/var/www/tp5blog/public/../application/index/view/index/index.html";i:1492927610;s:78:"/usr/local/var/www/tp5blog/public/../application/index/view/public/header.html";i:1493650059;s:75:"/usr/local/var/www/tp5blog/public/../application/index/view/public/nav.html";i:1493650089;s:77:"/usr/local/var/www/tp5blog/public/../application/index/view/public/right.html";i:1493208573;s:78:"/usr/local/var/www/tp5blog/public/../application/index/view/public/footer.html";i:1493207842;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="page-header">
                <h3><?php echo (isset($page_header) && ($page_header !== '')?$page_header:'全部文章'); ?></h3>
            </div>
            <?php if(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty())): ?>
            <h4 style="width: 100%;min-height: 500px;line-height: 500px;text-align: center;">
                暂无结果
            </h4>
            <?php else: if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="blog-content">
                <img class="img-rounded" src="/tp5blog/public/uploads/<?php echo $vo['img_path']; ?>"
                     style="margin-right: 10px;float: left;width: 100px;"/>
                <div class="content-detail" style="float: left;width: 80%">
                    <h4><a href="<?php echo url('index/index/detail',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a></h4>
                    <p>作者：<?php echo getUserName($vo['uid']); ?>&nbsp;&nbsp;
                        发布时间：<?php echo date('Y-m-d',$vo['create_time']); ?>&nbsp;&nbsp;
                        点击量：<?php echo $vo['pv']; ?>
                    </p>
                    <div><?php echo getDocBody($vo['content']); ?></div>
                    <hr/>
                </div>
