<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"/usr/local/var/www/tp5blog/public/../application/index/view/user/reg.html";i:1492781225;s:78:"/usr/local/var/www/tp5blog/public/../application/index/view/public/header.html";i:1493650059;s:75:"/usr/local/var/www/tp5blog/public/../application/index/view/public/nav.html";i:1493650089;s:77:"/usr/local/var/www/tp5blog/public/../application/index/view/public/right.html";i:1493208573;s:78:"/usr/local/var/www/tp5blog/public/../application/index/view/public/footer.html";i:1493207842;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <form method="post" class="reg_form" class="form" action="<?php echo url('index/user/add'); ?>" style="width: 50%;">

                <div class="form-group">
                    <label for="">用户名</label>
                    <input type="text" name="username" class="form-control" id="" placeholder="输入您的用户名">
                </div>

                <div class="form-group">
                    <label for="">邮箱</label>
                    <input type="text" name="email" class="form-control" id="" placeholder="输入您的邮箱">
                </div>

                <div class="form-group">
                    <label for="">手机号</label>
                    <input type="text" name="mobile" class="form-control" id="" placeholder="输入您的手机号">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirm" class="form-control" id="" placeholder="密码">
                </div>

                <input type="hidden" name="__token__" value="<?php echo \think\Request::instance()->token(); ?>" />
                <INPUT type="button" class="btn btn-default reg_btn" value="注册新用户">
